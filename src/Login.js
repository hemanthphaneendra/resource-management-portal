...
const Login = () => {
    ...
    return ( 
        <div style={{display:"flex",height:height1}}>
            <img style={{width:"500px",height:"400px",paddingTop:"10%",paddingLeft:"10%"}} src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.webp" alt="login"></img>
            <div style={{marginLeft:"250px"}}>
                <div className="login">
                    <div style={{display:"flex", marginTop:"100px"}}>
                        <p style={{fontSize:"23px",width:"100px",textAlign:"center",marginRight:"10px"}}>Sign In With</p>
                        <div style={{marginTop:"20px"}}>
                        <button style={{fontWeight:"bold",backgroundColor:"blue",color:"white",borderRadius:"50%",
                        border:"none",padding:"8px 20px",fontSize:"20px"}}>f</button>
                        <button style={{fontWeight:"bold",backgroundColor:"blue",color:"white",borderRadius:"50%",
                        border:"none",padding:"8px 18px",fontSize:"20px",marginLeft:"10px"}}>G</button>
                        <button style={{fontWeight:"bold",backgroundColor:"blue",color:"white",borderRadius:"50%",
                        border:"none",padding:"8px 16px",fontSize:"20px",marginLeft:"10px"}}>in</button>
                        </div>
                    </div>
                    <div style={{display:"flex"}}>
                        <div style={{borderTop: "1px solid #bbb",width:"120px",marginTop:"12px",marginRight:"5px"}}></div>
                        <p style={{fontSize:"17px",fontWeight:"bold"}}>Or</p>
                        <div style={{borderTop: "1px solid #bbb",width:"130px",marginTop:"12px",marginLeft:"5px"}}></div>
                    </div>
                    <form onSubmit={handleSubmit}>
                        ...
                        border:"1px solid #bbb",borderRadius:"4px",padding:"25px 10px",marginTop:"30px"}}/>
                        </div>
                        ...
                        border:"1px solid #bbb",borderRadius:"4px",padding:"25px 10px",marginTop:"20px"}}/>
                        </div>
                        <p style={{color:"red"}}>{formErrors.password}</p>
                        <button style={{marginTop:"30px",color:"white",backgroundColor:"blue",padding:"10px 30px",border:"none",borderRadius:"4px"}}>LOGIN</button>
                    </form>
